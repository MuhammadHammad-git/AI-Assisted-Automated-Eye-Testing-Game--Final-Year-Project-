...
# for i in range(5):
def machine_learning_model(First_time=True):
    # Load the TFLite model
    global i
    global full
    interpreter = tf.lite.Interpreter(model_path=sp + "5WORDS_MS.tflite")
